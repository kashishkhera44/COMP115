...
def gem_counting(stones, gems):
    """
    Parameters:
    - stones (string): A string representing the types of stones collected.
    - gems (string): A string representing the types of gems.
...
# Unit tests for gem_counting function
...
def students_id(ids):
    """
    This function calculates the number of different students who use the shuttle service.

    Parameters:
    - student_ids (list of strings): A list of student ids.
...
assert students_id(['002', '003', '001', '004', '002']) == 4
assert students_id(['002', '003', '001', '012', '003', '001']) == 4
assert students_id(['002', '005', '006', '012', '003', '001']) == 6
...
def students_id_occurrences(ids):
    """
    This function counts the occurrences of each different student who uses the shuttle service.

    Parameters:
    - ids (list of strings): A list of student IDs.

    Returns:
    - (dict): A dictionary containing the occurrences of each student.
    """
    id_dict = {}
    for id in ids:
        if id in id_dict:
...
def word_frequency(paragraph):
    ...
    Parameters:
    - paragraph (string): The paragraph to analyze.
