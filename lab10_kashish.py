...
Yes, the functions practice_for_index_1(nums, target) and practice_for_index_2(nums, target) have the same functionality. Both functions aim to find the index of the target value in the list nums, and they return the index of the first occurrence of the target value if it exists, or -1 if it doesn't.
...
functionality? Why? (5 marks)
Your answer is: 
No the ans here is 4 . practice_for_index_3(nums, target) keeps on searching for the value if it has already found it and doesnt break ie gives index of last occurance.
...
assert exist_in_both("", "hello") == 0
assert exist_in_both("hello", "") == 0
assert exist_in_both("kit", "kitchen") == 3
assert exist_in_both("apple", "ban") == 1
...
animals = ["cat", "dog", "cat", "cat", "dog", "cat", "elephant", "cat", "dog", "dog"]
assert more_than_2(animals) == ["cat", "dog"]
