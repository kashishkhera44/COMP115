...
while x < 10:
    x = x + 2   
    print(x) #now the value of x is 2 and so on
...
my_name = "Kashish Khera" # Change to your name
my_github_account = "https://github.com/kashishkhera44/kashish-public" # Change to your GitHub account
my_hobby = "travelling" # Change to your hobby
